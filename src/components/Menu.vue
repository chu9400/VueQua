...
export default {
  name: "Menu",
  computed: {
    ...mapState(["category02_State"]),
  },

  methods: {
    ...mapMutations([
      "category02_StateTrue",
      "category02_StateFalse",
      "category02_StateChange",
    ]),
  },
};
</script>
